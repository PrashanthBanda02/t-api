...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    metaTitle: Attribute.String &
      ...
      Attribute.DefaultTo<'We Are The Creative Mage'>;
    ...
    CompanyNavLinks: Attribute.DynamicZone<['buttons.nav-button']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ServicesNavLinks: Attribute.DynamicZone<['buttons.nav-button']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ContactUsNavLinks: Attribute.DynamicZone<['buttons.nav-button']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeaderHeader extends Schema.CollectionType {
  ...
  attributes: {
    ...
    navLinks: Attribute.DynamicZone<['buttons.nav-button']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeroSectionHeroSection extends Schema.CollectionType {
  ...
  attributes: {
    ...
    getStartedBtn: Attribute.Component<'buttons.nav-button'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
